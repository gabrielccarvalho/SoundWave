				...
				<div className='flex flex-row gap-8 mt-48 max-[568px]:flex-col max-[568px]:mt-12'>
					...
					<div className='flex flex-col w-1/3 max-[568px]:w-[90%] max-[568px]:mx-auto max-[568px]:my-0 border-2 border-indigo-900 bg-[rgba(255,255,255,0.05)] rounded-2xl px-8 py-16 items-center shadow-inner shadow-[rgba(255,255,255,0.4)]'>
						...
						<div className='flex flex-col justify-between h-full'>
							...
							<button className='group flex flex-row items-center justify-center gap-4 w-[300px] px-0 text-sm font-sans bg-indigo-950 border border-indigo-700 text-white rounded-3xl py-2 transition ease-in-out delay-75 hover:shadow-[0_0_20px_5px_rgba(99,102,241,0.5)] max-[568px]:mt-24'>
					...
					<div className='flex flex-col w-1/3 max-[568px]:w-[90%] max-[568px]:mx-auto max-[568px]:my-0 border-2 border-gray-800 rounded-2xl px-8 py-16 items-center'>
						...
						<div className='flex flex-col justify-between h-full'>
							...
							<button className='group flex flex-row justify-center items-center gap-4 w-[300px] text-sm font-sans bg-white border border-indigo-700 text-black rounded-3xl py-2 transition ease-in-out delay-75 hover:shadow-[0_0_20px_5px_rgba(99,102,241,0.5)] max-[568px]:mt-24'>
