...
const Footer = () => {
	return (
		<>
			...
			<div className='flex flex-row max-w-7xl my-0 mx-auto py-12 gap-28 justify-between max-[568px]:justify-center max-[568px]:flex-col px-3'>
